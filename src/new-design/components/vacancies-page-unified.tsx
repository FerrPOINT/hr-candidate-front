...
export function VacanciesPageUnified({
  ...
  // QuestionCard Component with Enhanced Drag & Drop
  const QuestionCard = ({ question, index }: { question: any; index: number }) => {
    // Use the question data directly from props instead of local state
    ...
    const [{ isOver }, drop] = useDrop({
      ...
      drop: (item: DragItem) => {
        ...
        // Move the question only on drop, not on hover
    ...
    return (
      <div
        ...
        style={{ 
          ...
          boxShadow: isOver ? '0 12px 32px rgba(225, 99, 73, 0.2)' : '0 4px 12px rgba(0,0,0,0.08)',
          border: isOver ? '2px solid #e16349' : '2px solid transparent'
        }}
      ...
      >
        ...
        <div className="mb-6">
          <textarea
            ...
            className="w-full h-[120px] p-6 border border-[#e2e4e9] rounded-[32px] text-[16px] text-[#0a0d14] resize-none outline-none focus:ring-0"
          />
        </div>
        ...
        <div className="flex items-center justify-end gap-3 mt-6">
          ...
          <button className="flex items-center gap-2 text-[#e16349] text-[14px] hover:opacity-75 transition-opacity">
          ...
          <button 
            ...
            className="flex items-center gap-2 text-[#e16349] text-[14px] hover:opacity-75 transition-opacity"
          >
                            ...
                            <div className="box-border content-stretch flex flex-col gap-6 items-start justify-start p-[24px] relative w-full">
                              ...
                              <div className="box-border content-stretch flex flex-row items-center justify-between p-0 relative shrink-0 w-full">
                                ...
                                <div className="box-border content-stretch flex flex-row gap-2 items-center justify-start p-0 relative shrink-0">
                                  ...
                                  {/* Create Interview */}
                                  <button className="bg-[#ffffff] box-border content-stretch flex flex-row gap-1 items-center justify-center overflow-clip p-[14px] relative rounded-3xl shrink-0 hover:bg-[#f6f8fa] transition-colors cursor-pointer border border-[#e16349]">
                                    <div className="box-border content-stretch flex flex-row gap-2 items-center justify-center px-1 py-0 relative shrink-0">
                                      <div className="css-1tg14q font-['Inter:Medium',_sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#e16349] text-[16px] text-center text-nowrap tracking-[-0.176px]">
                    ...
                    <div className="box-border content-stretch flex flex-row gap-2 items-center justify-end min-h-px min-w-px p-0 relative shrink-0">
                      <button
                        onClick={() => {
                          ...
                          onCreateInterview?.(selectedPositionId);
                        }}
                        disabled={!selectedPositionId}
                        className="bg-[#e16349] box-border content-stretch flex flex-row gap-1 items-center justify-center overflow-clip p-[14px] relative rounded-3xl shrink-0 hover:bg-[#d14a31] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        <div className="box-border content-stretch flex flex-row gap-2 items-center justify-center px-1 py-0 relative shrink-0">
                          <div className="css-rpndqk font-['Inter:Medium',_sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[16px] text-center text-nowrap tracking-[-0.176px]">
                            <p className="adjustLetterSpacing block leading-[24px] whitespace-pre">
